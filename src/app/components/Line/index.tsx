...
export default function Line() {
   ...
   useEffect(() => {
      ...
      if (!isAppLoading) {
         // const animation: gsap.core.Tween | null = null
...
//  * It takes a canvas element and draws the complete scribble onto it.
//  * @param canvas The HTMLCanvasElement to draw upon.
...
//    canvas.style.height = `${parentWidth * 1.3}px`
//    ctx.scale(dpr, dpr)
...
//    console.log(`center X: ${centerX}, canvasWidth: ${parentWidth}`)
//    const startY = (parentWidth * 1.3) - 50
//    const endY = 50
//    const totalHeight = startY - endY
//    const transitionY = startY - (totalHeight * config.transitionHeight)
